...
define(function () {
    ...
    var CommandManager = brackets.getModule('command/CommandManager'),
        ...
        menuId = 'font-menu',
        preferences = PreferencesManager.getExtensionPrefs('extensions.brackets-monospace-fonts'),
    ...
    function changeFont(name) {
        ...
        if (font) {
            ...
            preferences.set('selectedFont', font.name);
    ...
    if (!preferences.get('selectedFont')) {
        changeFont('Default');
    }
